        ...
        <div class="box-info">
            ...
            <div class="box-info-motorista">
                ...
                <div class="box-info-row">
                    ...
                    <span class="box-info-r">{{formatRS($row->vlradiantamento)}}</span>
                </div>
                ...
                <div class="box-info-row-2">
                    ...
                    <span class="box-info-r-2">{{$row->created_at->format('d/m/Y H:i')}}</span>
                </div>
            </div>
        </div>
        {{-- origem --}}
                    ...
                    <div class="box-checklist" style="text-align: left;" >
                        ...
                        <div class="box-checklist-row min">
                            <div class="box-checklist-field min" style="width: 250px;">
                                <b>Origem: </b>{{ ($row->cidadeorigem ? $row->cidadeorigem->cidade . ' / ' . $row->cidadeorigem->uf : ' - ') }}
                            </div>
                        </div>
                        @foreach ($row->roteiro as $key => $rota)
                            <div class="box-checklist-row min">
                                <div class="box-checklist-field min" style="width: 250px;">
                        ...
                        <div class="box-checklist-row min">
                            <div class="box-checklist-field min" style="width: 250px;">
                                <b>Destino: </b>{{ ($row->cidadedestino ? $row->cidadedestino->cidade . ' / ' . $row->cidadedestino->uf : ' - ') }}
                            </div>
                        </div>
                    </div>
                </td>
