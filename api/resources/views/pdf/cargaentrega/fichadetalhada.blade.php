...
<head>
    ...
    <title>Impressão de Carga de Entrega</title>
    <style>
    body {
        position: relative;
...
<div class="invoice-box" >
    <div class="box-info">
        ...
        <div class="box-info-motorista">
            <div class="box-info-row">
                <span class="box-info-l">Carga de Entrega</span>
    ...
    <div style="height: 150px; font-size: 28px; position: relative;   ">
        <div style="height: 150px; width: 150px; top: 1px; left: 1px; grey; position: absolute; ">
            {!! DNS2D::getBarcodeHTML( $carga->qrcodetext(), 'QRCODE', 3, 3, 'black'); !!}
        </div>
        <div style="height: 100px; width: 350px; top: 1px; left: 160px;  position: absolute; ">
            teste
        </div>
    </div>
