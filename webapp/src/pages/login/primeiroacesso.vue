      ...
      <div class="row flex-center full-width q-pa-lg" >
        <q-card flat bordered class="full-width bg-primary text-white" dark>
          ...
          <q-card-actions align="center" class="q-pa-md" v-if="internet ? internet.online : false">
            <q-btn class="full-width" color="accent" text-color="white" unelevated
              size="lg" label="Já sou cliente!" no-caps
              :loading="sending" :to="{ name: 'login.usuario'}" />
          </q-card-actions>
          <q-card-actions align="center" class="q-pa-md" v-if="internet ? internet.online : false">
            <q-btn class="full-width" color="secondary" text-color="primary" unelevated
              size="lg" label="Ainda não sou cliente" no-caps
              @click="$helpers.href('https://home.i12.com.br')"
              :loading="sending" />
          </q-card-actions>
          <q-card-section>
